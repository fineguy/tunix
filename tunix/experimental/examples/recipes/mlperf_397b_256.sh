...
export MAXTEXT_CKPT="gs://sanbao-europe/qwen35_397b/scanned_reshard_fsdp32_tp2/0/items"
...
# Topologies (128 chips Trainer 4x4x8, 8x 16-chip Rollout slices)
...
export ORCHESTRATOR_EXTRA_ENV="${ORCHESTRATOR_EXTRA_ENV:-WEIGHT_SYNC_TIMEOUT_H2D=3600 RAIDEN_PARALLELISM=16}"
